...
```
Disable-PSEntraIDGroupLicense -InputObject <Group[]> -SkuPartNumber <string[]> [-EnableException]
...
```
Disable-PSEntraIDGroupLicense -InputObject <Group[]> -SkuId <string[]> [-EnableException] [-Force]
...
```
Disable-PSEntraIDGroupLicense -Identity <string[]> -SkuPartNumber <string[]> [-EnableException]
 [-Force] [-PassThru] [-WhatIf] [-Confirm]
```
...
```
Disable-PSEntraIDGroupLicense -Identity <string[]> -SkuId <string[]> [-EnableException] [-Force]
 [-PassThru] [-WhatIf] [-Confirm]
```
...
Disable-PSEntraIDGroupLicense -Identity group1 -SkuPartNumber ENTERPRISEPACK
