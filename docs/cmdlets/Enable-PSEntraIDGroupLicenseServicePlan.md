...
title: Enable-PSEntraIDGroupLicenseServicePlan
---
...
```
Enable-PSEntraIDGroupLicenseServicePlan -InputObject <Group[]> -SkuPartNumber <string>
...
```
Enable-PSEntraIDGroupLicenseServicePlan -InputObject <Group[]> -SkuId <string>
 -ServicePlanName <string[]> [-EnableException] [-Force] [-PassThru] [-WhatIf] [-Confirm]
```
...
```
Enable-PSEntraIDGroupLicenseServicePlan -Identity <string[]> -SkuPartNumber <string>
 -ServicePlanName <string[]> [-EnableException] [-Force] [-PassThru] [-WhatIf] [-Confirm]
```
...
```
Enable-PSEntraIDGroupLicenseServicePlan -Identity <string[]> -SkuId <string>
 -ServicePlanName <string[]> [-EnableException] [-Force] [-PassThru] [-WhatIf] [-Confirm]
```
...
Enable-PSEntraIDGroupLicenseServicePlan -Identity group1 -SkuPartNumber ENTERPRISEPACK -ServicePlanName EXCHANGE_S_ENTERPRISE
