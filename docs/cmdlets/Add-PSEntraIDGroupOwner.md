...
```
Add-PSEntraIDGroupOwner -Identity <string> -InputObject <User[]> [-EnableException] [-Force]
...
```
Add-PSEntraIDGroupOwner -Identity <string> -User <string[]> [-EnableException] [-Force] [-PassThru]
