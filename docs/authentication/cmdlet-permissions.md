...
**Microsoft Graph API**: `GET /administrativeUnits/{id}/members`
- **Delegated**: `AdministrativeUnit.Read.All`, `Directory.Read.All`, or `Member.Read.Hidden`
- **Application**: `AdministrativeUnit.Read.All`, `Directory.Read.All`, or `Member.Read.Hidden`
- **Admin Consent Required**: Yes

### Add-PSEntraIDAdministrativeUnitMember
**Microsoft Graph API**: `POST /administrativeUnits/{id}/members/$ref`
- **Delegated**: `AdministrativeUnit.ReadWrite.All` or `Directory.ReadWrite.All`
- **Application**: `AdministrativeUnit.ReadWrite.All` or `Directory.ReadWrite.All`
- **Admin Consent Required**: Yes

### Remove-PSEntraIDAdministrativeUnitMember
**Microsoft Graph API**: `DELETE /administrativeUnits/{id}/members/{id}/$ref`
- **Delegated**: `AdministrativeUnit.ReadWrite.All` or `Directory.ReadWrite.All`
- **Application**: `AdministrativeUnit.ReadWrite.All` or `Directory.ReadWrite.All`
- **Admin Consent Required**: Yes
