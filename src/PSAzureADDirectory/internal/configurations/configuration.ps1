...
#>
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiVersion' -Value "v1.0" -Initialize -Validation 'string' -Description "What version of Graph API module is useing."
...
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.AuthorizationToken' -Value '' -Initialize -Validation 'string' -Description "Specifies the last authorization token of Graph Api to Office 365."
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Format' -Value 'json' -Initialize -Validation 'string' -Description "Specifies the media format of the items returned from Microsoft Graph Api."
...
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Select.AssignedLicense' -Value @('id', 'userPrincipalName','mail','accountEnabled','givenName','surname','displayName','jobTitle','department','companyName','city','postalCode','country','usageLocation','mobilePhone','businessPhones','faxNumber','assignedLicenses','assignedPlans','provisionedPlans') -Initialize -Validation 'stringarray' -Description "Specifies uery parameter to return a set of properties that are different than the default set for an individual resource or a collection of resources."
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Select.SubscribedSku' -Value @('id', 'skuId','skuPartNumber','appliesTo','prepaidUnits','consumedUnits','servicePlans') -Initialize -Validation 'stringarray' -Description "Specifies uery parameter to return a set of properties that are different than the default set for an individual resource or a collection of resources."
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Select.ServicePlan' -Value @('id', 'skuId','skuPartNumber','servicePlans') -Initialize -Validation 'stringarray' -Description "Specifies uery parameter to return a set of properties that are different than the default set for an individual resource or a collection of resources."
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Query.Level' -Value 'Default' -Initialize -Validation 'string' -Description "Query capabilities level (Default/Advanced). Default value is Default."
Set-PSFConfig -Module 'PSAzureADDirectory' -Name 'Settings.GraphApiQuery.Query.AdvancedQueryCapabilities.ConsistencyLevel ' -Value 'eventual' -Initialize -Validation 'string' -Description "Advanced query capabilities ConsistencyLevel settings."