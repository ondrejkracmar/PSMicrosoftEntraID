<#
	.SYNOPSIS
		Installs the PSAzureADDirectory Module from github
		
	.DESCRIPTION
		This script installs the PSAzureADDirectory Module from github.
