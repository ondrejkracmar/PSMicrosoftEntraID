...
```
Disable-PSEntraIDUserLicense -Identity <String[]> -SkuPartNumber <String[]> [-EnableException] [-Force]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### IdentitySkuId
```
Disable-PSEntraIDUserLicense -Identity <String[]> -SkuId <String[]> [-EnableException] [-Force] [-WhatIf]
