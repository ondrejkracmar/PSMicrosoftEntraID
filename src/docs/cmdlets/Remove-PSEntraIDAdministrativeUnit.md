...
title: Remove-PSEntraIDAdministrativeUnit
---
...
```
Remove-PSEntraIDAdministrativeUnit -InputObject <AdministrativeUnit[]> [-EnableException] [-Force]
...
```
Remove-PSEntraIDAdministrativeUnit -Identity <string[]> [-EnableException] [-Force] [-PassThru]
...
Remove-PSEntraIDAdministrativeUnit -Identity "Marketing AU"

Delete administrative unit "Marketing AU" from Microsoft Entra ID

### EXAMPLE 2

Get-PSEntraIDAdministrativeUnit -DisplayName "Old Department" | Remove-PSEntraIDAdministrativeUnit
...
When deleted, they can be restored within 30 days.
