...
```
Add-PSEntraIDGroupMember -Identity <string> -InputObject <User[]> [-EnableException] [-Force]
...
```
Add-PSEntraIDGroupMember -Identity <string> -User <string[]> [-EnableException] [-Force] [-PassThru]
