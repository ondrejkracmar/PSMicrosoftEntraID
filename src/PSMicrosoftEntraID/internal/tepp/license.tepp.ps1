...
Register-PSFTeppScriptblock -Name 'subscribed.skuid' -ScriptBlock { (Get-PSEntraIDSubscribedSku | Select-Object -Property SkuId).SkuId }
Register-PSFTeppScriptblock -Name 'subscribed.skupartnumber' -ScriptBlock { (Get-PSEntraIDSubscribedSku | Select-Object -Property SkuPartNumber).SkuPartNumber }
Register-PSFTeppScriptblock -Name 'subscribed.serviceplanid' -ScriptBlock { ((Get-PSEntraIDSubscribedSku).Serviceplans).ServicePlanId}
Register-PSFTeppScriptblock -Name 'subscribed.serviceplanname' -ScriptBlock { ((Get-PSEntraIDSubscribedSku).Serviceplans).ServicePlanName}
