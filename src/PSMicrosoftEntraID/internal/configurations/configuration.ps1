...
$licenseIdentifiers = Join-Path -Path (Join-Path -Path (Join-Path -Path $script:ModuleRoot -ChildPath 'internal') -ChildPath 'identifiers') -ChildPath 'LicenseIdentifiers.json'
