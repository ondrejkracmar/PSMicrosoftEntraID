...
Set-PSFConfig -Module $script:ModuleName -Name 'Settings.GraphApiQuery.Select.UserGuest' -Value @('id', 'createdDateTime', 'userPrincipalName', 'mail', 'mailNickname', 'proxyAddresses', 'userType', 'accountEnabled', 'givenName', 'surname', 'displayName', 'employeeId', 'jobTitle', 'department', 'officeLocation', 'companyName', 'city', 'postalCode', 'country', 'usageLocation', 'mobilePhone', 'businessPhones', 'faxNumber', 'assignedLicenses','ExternalUserState','ExternalUserStateChangeDateTime') -Initialize -Validation 'stringarray' -Description "Specifies filter select parameter to return a set of properties that are different than the default set for an individual resource or a collection of resources."
...
Set-PSFConfig -Module $script:ModuleName -Name 'Settings.GraphApiQuery.Select.ServiceAnnouncement.Message' -Value @('id', 'title', 'category', 'severity', 'services', 'tags', 'isMajorChange', 'lastModifiedDateTime', 'startDateTime', 'endDateTime', 'actionRequiredByDateTime', 'body', 'viewPoint', 'hasAttachments', 'attachmentsArchive', 'details') -Initialize -Validation 'stringarray' -Description "Specifies uery parameter to return a set of properties that are different than the default set for an individual resource or a collection of resources."
